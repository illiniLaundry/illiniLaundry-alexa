module.exports = {
    ...
    help_prompt: 'Welcome to Illini Laundry, to get laundry status from a dorm simply state the dorm name.',
    //Error prompts
    ...
    //Laundry prompts
    laundry_template: 'There are currently ${availWasher} washers and ${availDryer} dryers available in ${dormName}.',
    //Exit prompt
    exit_template: 'Thank you for using Illini Laundry'
}
